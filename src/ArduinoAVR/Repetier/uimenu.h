...
//#ifdef USER_QUICK_MENU_Z_PROBE_HEIGHT_USER_CHANGE
//UI_MENU_CHANGEACTION_T(ui_menu_z_offset_change, UI_TEXT_ZPROBE_HEIGHT_ID, UI_ACTION_Z_OFFSET_CHANGE)
UI_MENU_ACTION2_T(ui_menu_stall_guard_threshold_change, UI_ACTION_DUMMY, UI_TEXT_BED_COATING_SET1_ID, UI_TEXT_COATING_THICKNESS_ID)
UI_MENU_CHANGEACTION_FILTER_T(ui_menu_adjust_stall_guard_threshold_change, UI_TEXT_STALLGUARD_ITEM_ID, UI_ACTION_STALLGUARD_CHANGE, 0, MENU_MODE_PRINTING)
