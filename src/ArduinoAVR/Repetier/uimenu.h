...
#if UI_ROWS >= 4
UI_WIZARD4_T(ui_wiz_crashdetectaskheat, UI_ACTION_WIZARD_CRASH_ASKHEAT, UI_TEXT_WIZ_CRASH_21_ID, UI_TEXT_WIZ_CRASH_22_ID, UI_TEXT_WIZ_CRASH_23_ID, UI_TEXT_OK_ID)
...
UI_WIZARD4_T(ui_wiz_crashdetectrestart, UI_ACTION_WIZARD_CRASH_RESTART, UI_TEXT_WIZ_CRASH_41_ID, UI_TEXT_WIZ_CRASH_42_ID, UI_TEXT_WIZ_CRASH_43_ID, UI_TEXT_CURRENT_TEMP_ID)
#else
...
#if UI_ROWS >= 4
UI_WIZARD4_T(ui_wiz_aclostdetectaskheat, UI_ACTION_WIZARD_AC_LOST_ASKHEAT, UI_TEXT_WIZ_AC_LOST_21_ID, UI_TEXT_WIZ_AC_LOST_22_ID, UI_TEXT_WIZ_AC_LOST_23_ID, UI_TEXT_OK_ID)
...
//#ifdef USER_QUICK_MENU_Z_PROBE_HEIGHT_USER_CHANGE
//UI_MENU_CHANGEACTION_T(ui_menu_z_offset_change, UI_TEXT_ZPROBE_HEIGHT_ID, UI_ACTION_Z_OFFSET_CHANGE)
UI_MENU_ACTION2_T(ui_menu_stall_guard_threshold_change, UI_ACTION_DUMMY, UI_TEXT_WIZ_CRASH_13_TEXT, UI_TEXT_WIZ_CRASH_23_TEXT)
...
#define UI_MENU_SERVICE {UI_MENU_ADDCONDBACK SERVICE_MENU_ITEM1 SERVICE_MENU_ITEM2 SERVICE_MENU_ITEM3 STALLGUARD_CHANGE SERVICE_MENU_ITEM4 SERVICE_MENU_ITEM5}
UI_MENU(ui_menu_service, UI_MENU_SERVICE, UI_MENU_BACKCNT + UI_SERVICE_MENU_ITEM1_CNT + UI_SERVICE_MENU_ITEM2_CNT + UI_SERVICE_MENU_ITEM3_CNT + STALLGUARD_CHANGE_CNT + UI_SERVICE_MENU_ITEM4_CNT + UI_SERVICE_MENU_ITEM5_CNT)
