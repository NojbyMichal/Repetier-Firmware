...
#if CRASH_DETECT
#if UI_ROWS >= 4
UI_WIZARD4_T(ui_wiz_crashdetectbegin, UI_ACTION_WIZARD_CRASH_BEGIN, UI_TEXT_WIZ_CH_FILAMENT1_ID, UI_TEXT_WIZ_CH_FILAMENT2_ID, UI_TEXT_WIZ_CH_FILAMENT3_ID, UI_TEXT_CLICK_DONE_ID)
UI_WIZARD4_T(ui_wiz_crashdetectwaitheat, UI_ACTION_WIZARD_CRASH_WAITHEAT, UI_TEXT_WIZ_WAITTEMP1_ID, UI_TEXT_WIZ_WAITTEMP2_ID, UI_TEXT_EMPTY_ID, UI_TEXT_TEMP_SET_ID)
UI_WIZARD4_T(ui_wiz_crashdetectreheat, UI_ACTION_WIZARD_CRASH_REHEAT, UI_TEXT_WIZ_REHEAT1_ID, UI_TEXT_WIZ_REHEAT2_ID, UI_TEXT_EMPTY_ID, UI_TEXT_CURRENT_TEMP_ID)
UI_WIZARD4_T(ui_wiz_crashdetectrestart, UI_ACTION_WIZARD_CRASH_RESTART, UI_TEXT_WIZ_REHEAT1_ID, UI_TEXT_WIZ_REHEAT2_ID, UI_TEXT_EMPTY_ID, UI_TEXT_CURRENT_TEMP_ID)
#else
UI_WIZARD2_T(ui_wiz_crashdetectbegin, UI_ACTION_WIZARD_CRASH_BEGIN, UI_TEXT_WIZ_CH_FILAMENT1_ID, UI_TEXT_CLICK_DONE_ID)
UI_WIZARD2_T(ui_wiz_crashdetectwaitheat, UI_ACTION_WIZARD_CRASH_WAITHEAT, UI_TEXT_WIZ_WAITTEMP1_ID, UI_TEXT_WIZ_WAITTEMP2_ID)
UI_WIZARD2_T(ui_wiz_crashdetectreheat, UI_ACTION_WIZARD_CRASH_REHEAT, UI_TEXT_WIZ_REHEAT1_ID, UI_TEXT_WIZ_REHEAT2_ID)
UI_WIZARD2_T(ui_wiz_crashdetectrestart, UI_ACTION_WIZARD_CRASH_RESTART, UI_TEXT_WIZ_REHEAT1_ID, UI_TEXT_WIZ_REHEAT2_ID)
#endif
#endif
...
#define UI_MENU_QUICK {UI_MENU_ADDCONDBACK &ui_menu_home_all BABY_ENTRY ,&ui_menu_quick_speedmultiply UI_MENU_FLOWCONF_COND \
    UI_TOOGLE_LIGHT_ENTRY UI_FANSPEED UI_FAN2SPEED UI_CHANGE_FIL_ENT UI_MENU_PREHEAT_COND Z_OFFSET_USER_CHANGE CUSTOM_SCRIPT1 CUSTOM_SCRIPT2 CUSTOM_SCRIPT3 CUSTOM_SCRIPT4 CUSTOM_SCRIPT5 ,&ui_menu_quick_origin, \
    &ui_menu_quick_stopstepper MENU_PSON_ENTRY DEBUG_PRINT_EXTRA}
UI_MENU(ui_menu_quick, UI_MENU_QUICK, 4 + Z_OFFSET_USER_CHANGE_CNT + CUSTOM_SCRIPT1_CNT + CUSTOM_SCRIPT2_CNT + CUSTOM_SCRIPT3_CNT + CUSTOM_SCRIPT4_CNT + CUSTOM_SCRIPT5_CNT + BABY_CNT + UI_MENU_BACKCNT + MENU_PSON_COUNT + DEBUG_PRINT_COUNT + UI_MENU_FLOWCONF_CNT + UI_TOGGLE_LIGHT_COUNT + UI_CHANGE_FIL_CNT + UI_MENU_PREHEAT_CNT + UI_MENU_FAN_CNT + UI_MENU_FAN2_CNT)
