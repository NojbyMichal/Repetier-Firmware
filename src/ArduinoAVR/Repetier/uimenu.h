...
#define UI_MENU_QUICK {UI_MENU_ADDCONDBACK &ui_menu_home_all BABY_ENTRY ,&ui_menu_quick_speedmultiply UI_MENU_FLOWCONF_COND \
    UI_TOOGLE_LIGHT_ENTRY UI_FANSPEED UI_FAN2SPEED UI_CHANGE_FIL_ENT UI_MENU_PREHEAT_COND Z_OFFSET_USER_CHANGE CUSTOM_SCRIPT1 CUSTOM_SCRIPT2 CUSTOM_SCRIPT3 CUSTOM_SCRIPT4 CUSTOM_SCRIPT5 ,&ui_menu_quick_calibrate_bed ,&ui_menu_quick_origin, \
