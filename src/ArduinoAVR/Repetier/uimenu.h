...
UI_WIZARD4_T(ui_wiz_aclostdetectrestart, UI_ACTION_WIZARD_AC_LOST_RESTART, UI_TEXT_WIZ_AC_LOST_41_ID, UI_TEXT_WIZ_AC_LOST_42_ID, UI_TEXT_EMPTY_ID, UI_TEXT_CURRENT_TEMP_ID)
#else
