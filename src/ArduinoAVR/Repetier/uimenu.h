...
#define CUSTOM_SCRIPT3 &ui_menu_custom_script4,
...
#define UI_MENU_QUICK {UI_MENU_ADDCONDBACK &ui_menu_home_all BABY_ENTRY ,&ui_menu_quick_speedmultiply,&ui_menu_quick_flowmultiply UI_TOOGLE_LIGHT_ENTRY UI_CHANGE_FIL_ENT,&ui_menu_quick_preheat_pla,&ui_menu_quick_preheat_abs, CUSTOM_SCRIPT1 CUSTOM_SCRIPT2 CUSTOM_SCRIPT3 CUSTOM_SCRIPT4 CUSTOM_SCRIPT5 &ui_menu_quick_cooldown,&ui_menu_quick_origin,&ui_menu_quick_stopstepper MENU_PSON_ENTRY DEBUG_PRINT_EXTRA}
UI_MENU(ui_menu_quick, UI_MENU_QUICK, 8 + CUSTOM_SCRIPT1_CNT + CUSTOM_SCRIPT2_CNT + CUSTOM_SCRIPT3_CNT + CUSTOM_SCRIPT4_CNT + CUSTOM_SCRIPT5_CNT + BABY_CNT + UI_MENU_BACKCNT + MENU_PSON_COUNT + DEBUG_PRINT_COUNT + UI_TOGGLE_LIGHT_COUNT + UI_CHANGE_FIL_CNT ) //+8
