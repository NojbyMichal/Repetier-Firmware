...
UI_MENU_ACTIONCOMMAND_T(ui_menu_quick_calibrate_bed,UI_TEXT_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_1_ID,UI_ACTION_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_1)
#endif
#ifdef USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_2
UI_MENU_ACTIONCOMMAND_T(ui_menu_quick_calibrate_bed,UI_TEXT_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_2_ID,UI_ACTION_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_2)
#endif
#ifdef USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_3
UI_MENU_ACTIONCOMMAND_T(ui_menu_quick_calibrate_bed,UI_TEXT_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_3_ID,UI_ACTION_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_3)
#endif
#ifdef USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_4
UI_MENU_ACTIONCOMMAND_T(ui_menu_quick_calibrate_bed,UI_TEXT_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_4_ID,UI_ACTION_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_4)
#endif
#ifdef USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_5
UI_MENU_ACTIONCOMMAND_T(ui_menu_quick_calibrate_bed,UI_TEXT_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_5_ID,UI_ACTION_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_5)
#endif
...
#define UI_MENU_QUICK {UI_MENU_ADDCONDBACK &ui_menu_home_all BABY_ENTRY ,&ui_menu_quick_speedmultiply,&ui_menu_quick_flowmultiply UI_TOOGLE_LIGHT_ENTRY UI_CHANGE_FIL_ENT,&ui_menu_quick_preheat_pla,&ui_menu_quick_preheat_abs,&ui_menu_quick_calibrate_bed,&ui_menu_quick_calibrate_bed,&ui_menu_quick_cooldown,&ui_menu_quick_origin,&ui_menu_quick_stopstepper MENU_PSON_ENTRY DEBUG_PRINT_EXTRA}
