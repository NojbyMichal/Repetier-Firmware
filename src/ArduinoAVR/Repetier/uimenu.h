...
#if CRASH_DETECT
UI_MENU_HEADLINE_T(ui_menu_crash_ask_head, UI_TEXT_WIZ_CRASH_11_ID)
UI_MENU_HEADLINE_T(ui_menu_crash_ask_head2, UI_TEXT_WIZ_CRASH_12_ID)
UI_MENU_ACTIONCOMMAND_T(ui_menu_crash_ask_no, UI_TEXT_NO_ID, UI_ACTION_WIZARD_CRASH_CANCEL)
UI_MENU_ACTIONCOMMAND_FILTER_T(ui_menu_crash_ask_yes,      UI_TEXT_YES_ID, UI_ACTION_WIZARD_CRASH_ASKHEAT    , 0, 0)

#define UI_MENU_CRASH_ASK {&ui_menu_crash_ask_head,&ui_menu_crash_ask_head2,&ui_menu_crash_ask_no,&ui_menu_crash_ask_yes}
UI_MENU(ui_menu_crash_ask, UI_MENU_CRASH_ASK, 4)

#if UI_ROWS >= 4
UI_WIZARD4_T(ui_wiz_crashdetectaskheat, UI_ACTION_WIZARD_CRASH_ASKHEAT, UI_TEXT_WIZ_CRASH_21_ID, UI_TEXT_WIZ_CRASH_22_ID, UI_TEXT_EMPTY_ID, UI_TEXT_OK_ID)

//UI_WIZARD4_T(ui_wiz_crashdetectbegin, UI_ACTION_WIZARD_CRASH_BEGIN, UI_TEXT_WIZ_CRASH_11_ID, UI_TEXT_WIZ_CRASH_12_ID, UI_TEXT_EMPTY_ID, UI_TEXT_CLICK_DONE_ID)
//UI_WIZARD4_T(ui_wiz_crashdetectreheat, UI_ACTION_WIZARD_CRASH_WAITHEAT, UI_TEXT_WIZ_CRASH_31_ID, UI_TEXT_WIZ_CRASH_32_ID, UI_TEXT_WIZ_CRASH_33_ID, UI_TEXT_TEMP_SET_ID)
UI_WIZARD4_T(ui_wiz_crashdetectwaitheat, UI_ACTION_WIZARD_CRASH_WAITHEAT, UI_TEXT_WIZ_CRASH_31_ID, UI_TEXT_WIZ_CRASH_32_ID, UI_TEXT_WIZ_CRASH_33_ID, UI_TEXT_TEMP_SET_ID)
UI_WIZARD4_T(ui_wiz_crashdetectrestart, UI_ACTION_WIZARD_CRASH_RESTART, UI_TEXT_WIZ_CRASH_41_ID, UI_TEXT_WIZ_CRASH_42_ID, UI_TEXT_EMPTY_ID, UI_TEXT_CURRENT_TEMP_ID)
#else
UI_WIZARD2_T(ui_wiz_crashdetectbegin, UI_ACTION_WIZARD_CRASH_BEGIN, UI_TEXT_WIZ_CRASH_11_ID, UI_TEXT_CLICK_DONE_ID)
UI_WIZARD2_T(ui_wiz_crashdetectwaitheat, UI_ACTION_WIZARD_CRASH_WAITHEAT, UI_TEXT_WIZ_CRASH_21_ID, UI_TEXT_WIZ_WAITTEMP2_ID)
UI_WIZARD2_T(ui_wiz_crashdetectreheat, UI_ACTION_WIZARD_CRASH_REHEAT, UI_TEXT_WIZ_CRASH_31_ID, UI_TEXT_WIZ_REHEAT2_ID)
UI_WIZARD2_T(ui_wiz_crashdetectrestart, UI_ACTION_WIZARD_CRASH_RESTART, UI_TEXT_WIZ_CRASH_41_ID, UI_TEXT_WIZ_REHEAT2_ID)
#endif
#endif

#if AC_LOST_DETECT
UI_MENU_HEADLINE_T(ui_menu_ac_lost_ask_head, UI_TEXT_WIZ_AC_LOST_11_ID)
UI_MENU_HEADLINE_T(ui_menu_ac_lost_ask_head2, UI_TEXT_WIZ_AC_LOST_12_ID)
UI_MENU_ACTIONCOMMAND_T(ui_menu_ac_lost_ask_no, UI_TEXT_NO_ID, UI_ACTION_WIZARD_AC_LOST_CANCEL)
UI_MENU_ACTIONCOMMAND_FILTER_T(ui_menu_ac_lost_ask_yes,      UI_TEXT_YES_ID, UI_ACTION_WIZARD_AC_LOST_ASKHEAT    , 0, 0)

#define UI_MENU_AC_LOST_ASK {&ui_menu_ac_lost_ask_head,&ui_menu_ac_lost_ask_head2,&ui_menu_ac_lost_ask_no,&ui_menu_ac_lost_ask_yes}
UI_MENU(ui_menu_ac_lost_ask, UI_MENU_AC_LOST_ASK, 4)

#if UI_ROWS >= 4
UI_WIZARD4_T(ui_wiz_aclostdetectaskheat, UI_ACTION_WIZARD_AC_LOST_ASKHEAT, UI_TEXT_WIZ_AC_LOST_21_ID, UI_TEXT_WIZ_AC_LOST_22_ID, UI_TEXT_EMPTY_ID, UI_TEXT_OK_ID)

//UI_WIZARD4_T(ui_wiz_crashdetectbegin, UI_ACTION_WIZARD_CRASH_BEGIN, UI_TEXT_WIZ_CRASH_11_ID, UI_TEXT_WIZ_CRASH_12_ID, UI_TEXT_WIZ_CRASH_13_ID, UI_TEXT_CLICK_DONE_ID)
//UI_WIZARD4_T(ui_wiz_crashdetectreheat, UI_ACTION_WIZARD_CRASH_WAITHEAT, UI_TEXT_WIZ_CRASH_31_ID, UI_TEXT_WIZ_CRASH_32_ID, UI_TEXT_WIZ_CRASH_33_ID, UI_TEXT_TEMP_SET_ID)
UI_WIZARD4_T(ui_wiz_aclostdetectwaitheat, UI_ACTION_WIZARD_AC_LOST_WAITHEAT, UI_TEXT_WIZ_AC_LOST_31_ID, UI_TEXT_WIZ_AC_LOST_32_ID, UI_TEXT_WIZ_AC_LOST_33_ID, UI_TEXT_TEMP_SET_ID)
UI_WIZARD4_T(ui_wiz_aclostdetectrestart, UI_ACTION_WIZARD_AC_LOST_RESTART, UI_TEXT_WIZ_AC_LOST_41_ID, UI_TEXT_WIZ_AC_LOST_42_ID, UI_TEXT_WIZ_AC_LOST_43_ID, UI_TEXT_CURRENT_TEMP_ID)
#else
UI_WIZARD2_T(ui_wiz_aclostdetectbegin, UI_ACTION_WIZARD_AC_LOST_BEGIN, UI_TEXT_WIZ_AC_LOST_11_ID, UI_TEXT_CLICK_DONE_ID)
UI_WIZARD2_T(ui_wiz_aclostdetectwaitheat, UI_ACTION_WIZARD_AC_LOST_WAITHEAT, UI_TEXT_WIZ_AC_LOST_21_ID, UI_TEXT_WIZ_WAITTEMP2_ID)
UI_WIZARD2_T(ui_wiz_aclostdetectreheat, UI_ACTION_WIZARD_AC_LOST_REHEAT, UI_TEXT_WIZ_AC_LOST_31_ID, UI_TEXT_WIZ_REHEAT2_ID)
UI_WIZARD2_T(ui_wiz_aclostdetectrestart, UI_ACTION_WIZARD_AC_LOST_RESTART, UI_TEXT_WIZ_AC_LOST_41_ID, UI_TEXT_WIZ_REHEAT2_ID)
#endif
#endif
...
//#ifdef USER_QUICK_MENU_Z_PROBE_HEIGHT_USER_CHANGE
//UI_MENU_CHANGEACTION_T(ui_menu_z_offset_change, UI_TEXT_ZPROBE_HEIGHT_ID, UI_ACTION_Z_OFFSET_CHANGE)
UI_MENU_ACTION2_T(ui_menu_z_offset_change, UI_ACTION_DUMMY, UI_TEXT_ZPROBE_HEIGHT_ID, UI_TEXT_EMPTY_ID)
...
#ifdef DRV_TMC2130
UI_MENU_ACTIONCOMMAND_T(ui_menu_stealhchop_enable, UI_TEXT_WIZ_AC_LOST_43_ID, UI_ACTION_STEALTHCHOP_ENABLE)

#define STEALTHCHOP_EN_CNT 1 
#define STEALTHCHOP_EN ,&ui_menu_stealhchop_enable
#else
#define STEALTHCHOP_EN_CNT 0
#define STEALTHCHOP_EN
/*
UI_MENU_ACTION2_T(ui_menu_stealthchop_change, UI_ACTION_DUMMY, UI_TEXT_WIZ_AC_LOST_13_ID, UI_TEXT_EMPTY_ID)
UI_MENU_CHANGEACTION_T(ui_menu_adjust_stealthchop_change, UI_TEXT_WIZ_CRASH_43_ID, UI_ACTION_STEALTHCHOP_CHANGE)

#define STEALTHCHOP_CHANGE_CNT 1 
#define STEALTHCHOP_CHANGE ,&ui_menu_adjust_stealthchop_change
#else
#define STEALTHCHOP_CHANGE_CNT 0
#define STEALTHCHOP_CHANGE
*/
#endif
...
//#ifdef USER_QUICK_MENU_Z_PROBE_HEIGHT_USER_CHANGE
//UI_MENU_CHANGEACTION_T(ui_menu_z_offset_change, UI_TEXT_ZPROBE_HEIGHT_ID, UI_ACTION_Z_OFFSET_CHANGE)
UI_MENU_ACTION2_T(ui_menu_stall_guard_threshold_change, UI_ACTION_DUMMY, UI_TEXT_WIZ_CRASH_13_ID, UI_TEXT_WIZ_CRASH_23_ID)
//UI_MENU_CHANGEACTION_FILTER_T(ui_menu_adjust_stall_guard_threshold_change, UI_TEXT_ON_ID, UI_ACTION_STALLGUARD_CHANGE, 0, MENU_MODE_PRINTING)
UI_MENU_CHANGEACTION_T(ui_menu_adjust_stall_guard_threshold_change, UI_TEXT_STALLGUARD_ITEM_ID, UI_ACTION_STALLGUARD_CHANGE)
//UI_MENU_CHANGEACTION_T
#define STALLGUARD_CHANGE_CNT 1 
#define STALLGUARD_CHANGE ,&ui_menu_adjust_stall_guard_threshold_change


UI_MENU_ACTIONCOMMAND_T(ui_menu_crash_enable, UI_TEXT_WIZ_AC_LOST_23_ID, UI_ACTION_CRASH_ENABLE)

#define CRASH_EN_CNT 1 
#define CRASH_EN ,&ui_menu_crash_enable

#else
#define STALLGUARD_CHANGE_CNT 0 
#define STALLGUARD_CHANGE 

#define CRASH_EN_CNT 0 
#define CRASH_EN 

#endif

#ifdef UI_SERVICE_MENU_ITEM1 
UI_MENU_ACTIONCOMMAND(ui_service_menu_item1,UI_SERVICE_MENU_ITEM1_TEXT,UI_ACTION_SERVICE_MENU_ITEM1)
...
UI_MENU_ACTIONCOMMAND(ui_service_menu_item2,UI_SERVICE_MENU_ITEM2_TEXT,UI_ACTION_SERVICE_MENU_ITEM2)
...
UI_MENU_ACTIONCOMMAND(ui_service_menu_item3,UI_SERVICE_MENU_ITEM3_TEXT,UI_ACTION_SERVICE_MENU_ITEM3)
...
UI_MENU_ACTIONCOMMAND(ui_service_menu_item4,UI_SERVICE_MENU_ITEM4_TEXT,UI_ACTION_SERVICE_MENU_ITEM4)
...
UI_MENU_ACTIONCOMMAND(ui_service_menu_item5,UI_SERVICE_MENU_ITEM5_TEXT,UI_ACTION_SERVICE_MENU_ITEM5)
...
#define UI_MENU_SERVICE {UI_MENU_ADDCONDBACK SERVICE_MENU_ITEM1 SERVICE_MENU_ITEM2 SERVICE_MENU_ITEM3 STEALTHCHOP_EN CRASH_EN STALLGUARD_CHANGE SERVICE_MENU_ITEM4 SERVICE_MENU_ITEM5}
UI_MENU(ui_menu_service, UI_MENU_SERVICE, UI_MENU_BACKCNT + UI_SERVICE_MENU_ITEM1_CNT + UI_SERVICE_MENU_ITEM2_CNT + UI_SERVICE_MENU_ITEM3_CNT +STEALTHCHOP_EN_CNT +CRASH_EN_CNT + STALLGUARD_CHANGE_CNT + UI_SERVICE_MENU_ITEM4_CNT + UI_SERVICE_MENU_ITEM5_CNT)
UI_MENU_SUBMENU_T(ui_menu_service_sub, UI_TEXT_SERVICE_MENU_ID , ui_menu_service)
