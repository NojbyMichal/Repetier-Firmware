...
UI_MENU_ACTIONCOMMAND_T(ui_menu_crash_ask_no, UI_TEXT_NO_ID, UI_ACTION_WIZARD_CRASH_WAITHEAT)
UI_MENU_ACTIONCOMMAND_FILTER_T(ui_menu_crash_ask_yes,      UI_TEXT_YES_ID, UI_ACTION_WIZARD_CRASH_REHEAT    , 0, 0)

#define UI_MENU_CRASH_ASK {&ui_menu_crash_ask_head,&ui_menu_crash_ask_no,&ui_menu_crash_ask_yes}
UI_MENU(ui_menu_crash_ask, UI_MENU_CRASH_ASK, 3)
...
UI_WIZARD4_T(ui_wiz_crashdetectwaitheat, UI_ACTION_WIZARD_CRASH_WAITHEAT, UI_TEXT_WIZ_CRASH_21_ID, UI_TEXT_WIZ_CRASH_22_ID, UI_TEXT_WIZ_CRASH_23_ID, UI_TEXT_TEMP_SET_ID)
UI_WIZARD4_T(ui_wiz_crashdetectreheat, UI_ACTION_WIZARD_CRASH_REHEAT, UI_TEXT_WIZ_CRASH_31_ID, UI_TEXT_WIZ_CRASH_32_ID, UI_TEXT_WIZ_CRASH_33_ID, UI_TEXT_CURRENT_TEMP_ID)
